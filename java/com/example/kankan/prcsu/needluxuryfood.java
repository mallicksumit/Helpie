...
public class needluxuryfood extends AppCompatActivity {
    Button btnlookfor;
    DatabaseHelper myDb;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_needluxuryfood);
        btnlookfor=(Button)findViewById(R.id.btnlookfor);
        mList = (ListView) findViewById(R.id.list_view_needluxuryfood);
        list = new ArrayList<>();
        viewAll();
                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        while (res.moveToNext()) {
                            if (res.getString(5).equalsIgnoreCase("Luxuryfood"))
                            {
                        ...
                        adapter = new ArrayAdapter<String>(needluxuryfood.this, android.R.layout.simple_list_item_1, list);
