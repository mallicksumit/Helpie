...
public class needcoal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_needcoal);
                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        while (res.moveToNext()) {
                            if (res.getString(5).equalsIgnoreCase("coal"))
                            {
                        ...
                        adapter = new ArrayAdapter<String>(needcoal.this, android.R.layout.simple_list_item_1, list);
