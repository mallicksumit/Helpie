...
public class needpaidfood extends AppCompatActivity {
    Button btnlookfor;
    DatabaseHelper myDb;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_needpaidfood);
        btnlookfor=(Button)findViewById(R.id.btnlookfor);
        mList = (ListView) findViewById(R.id.list_view_needpaidfood);
        list = new ArrayList<>();
        viewAll();
                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        while (res.moveToNext()) {
                            if (res.getString(5).equalsIgnoreCase("PAIDFOOD"))
                            {
                        ...
                        adapter = new ArrayAdapter<String>(needpaidfood.this, android.R.layout.simple_list_item_1, list);
