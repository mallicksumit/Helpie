...
public class needelectricity extends AppCompatActivity {
    Button btnlookfor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_needelectricity);
        btnlookfor=(Button)findViewById(R.id.btnlookfor);
        mList = (ListView) findViewById(R.id.list_view_needcoal);
        list = new ArrayList<>();
        viewAll();
                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        while (res.moveToNext()) {
                            if (res.getString(5).equalsIgnoreCase("electricity"))
                            {
                        ...
                        adapter = new ArrayAdapter<String>(needelectricity.this, android.R.layout.simple_list_item_1, list);
