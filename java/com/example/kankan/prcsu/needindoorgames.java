...
public class needindoorgames extends AppCompatActivity {
    Button btnlookfor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_needindoorgames);
        btnlookfor=(Button)findViewById(R.id.btnlookfor);
        mList = (ListView) findViewById(R.id.list_view_needindoorgames);
        list = new ArrayList<>();
        viewAll();
                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        while (res.moveToNext()) {
                            if (res.getString(5).equalsIgnoreCase("INDOORGAMES"))
                            {
                        ...
                        adapter = new ArrayAdapter<String>(needindoorgames.this, android.R.layout.simple_list_item_1, list);
