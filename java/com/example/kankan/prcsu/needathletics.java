...
public class needathletics extends AppCompatActivity {
    Button btnlookfor;
    DatabaseHelper myDb;
    ListView mList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_needathletics);
        btnlookfor=(Button)findViewById(R.id.btnlookfor);
        mList = (ListView) findViewById(R.id.list_view_needathletics);
        list = new ArrayList<>();
        viewAll();
                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        while (res.moveToNext()) {
                            if (res.getString(5).equalsIgnoreCase("athletics"))
                            {
                        ...
                        adapter = new ArrayAdapter<String>(needathletics.this, android.R.layout.simple_list_item_1, list);
