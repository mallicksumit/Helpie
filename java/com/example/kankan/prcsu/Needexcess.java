...
public class Needexcess extends AppCompatActivity {
    Button btnlookfor;
    DatabaseHelper myDb;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_needexcess);
        btnlookfor=(Button)findViewById(R.id.btnlookfor);
        mList = (ListView) findViewById(R.id.list_view_needexcess);
        list = new ArrayList<>();
        viewAll();
                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        while (res.moveToNext()) {
                            if (res.getString(5).equalsIgnoreCase("Need"))
                            {
                        ...
                        adapter = new ArrayAdapter<String>(Needexcess.this, android.R.layout.simple_list_item_1, list);
