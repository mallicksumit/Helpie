...
public class needgas extends AppCompatActivity {
    Button btnlookfor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_needgas);
        btnlookfor=(Button)findViewById(R.id.btnlookfor);
        mList = (ListView) findViewById(R.id.list_view_needgas);
        list = new ArrayList<>();
        viewAll();
                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        while (res.moveToNext()) {
                            if (res.getString(5).equalsIgnoreCase("GAS"))
                            {
                        ...
                        adapter = new ArrayAdapter<String>(needgas.this, android.R.layout.simple_list_item_1, list);
