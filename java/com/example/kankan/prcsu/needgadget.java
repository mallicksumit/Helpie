...
public class needgadget extends AppCompatActivity {
    Button btnlookfor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_needgadget);
        btnlookfor=(Button)findViewById(R.id.btnlookfor);
        mList = (ListView) findViewById(R.id.list_view_needgadget);
        list = new ArrayList<>();
        viewAll();
                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        while (res.moveToNext()) {
                            if (res.getString(5).equalsIgnoreCase("GADGET"))
                            {
                        ...
                        adapter = new ArrayAdapter<String>(needgadget.this, android.R.layout.simple_list_item_1, list);
